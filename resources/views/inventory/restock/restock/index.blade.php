        ...
        <div class="row">
            ...
            <div class="col-xxl-6 col-md-6">
                <div class="card info-card sales-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Data Restock <span>| On-Progress</span></h5>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-3">
                                <h6>145</h6>
                                <span class="text-muted small pt-2 ps-1">On-Progress</span>
                            </div>
            ...
            <div class="col-xxl-6 col-md-6">
                ...
                <div class="card info-card customers-card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Data Restock <span>| Pending</span></h5>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">List Restock <span>| Warehouse</span></h5>
                        <button type="button" class="btn btn-primary">Add Restock</button>
