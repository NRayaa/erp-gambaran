            ...
            <div class="col-sm-4 row">
                ...
                <div class="col-12">
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Customer <span>| All</span></h5>
                ...
                <div class="col-12">
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Customer <span>| Add</span></h5>
                            <div class="d-flex align-items-center">
                                <div class="ps-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="mb-3 col-sm-12">
                                            <input type="number" class="form-control" placeholder="Customer's Address">
                                        </div>
                                        <div class="mb-3 col-sm-12">
                                            <input type="number" class="form-control" placeholder="Customer's Phone">
                                        </div>
                                        <div class="row my-3">
                                            <div class="col-sm-10">
